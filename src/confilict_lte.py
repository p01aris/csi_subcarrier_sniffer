...
class thread_manager(threading.Thread): #The timer class is derived from the class threading.Thread
    ...
    def __init__(self,node):
        ...
        if 'WIFI' in node:
            self.rf_client1=WIFI_client(node);
        elif 'LTE' in node:
            self.rf_client1=LTE_client(node);
        if 'LAA' in node:
            self.rf_client1=LAA_client(node);
        elif 'LASI' in node:
            self.rf_client1=LASI_client(node);
...
if __name__ == '__main__':
    ...
    # ap_num.append('LTE1');
    # ap_num.append('LTE2');    #ap_num.append('LAA1');
    # ap_num.append('LTE3');
    # ap_num.append('LTE4');
    # ap_num.append('LTE5');
    # #ap_num.append('LASI1');
